...
public class CommandWanderingTrader {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
		dispatcher.register(Commands.literal("wandering-trader").requires((iCommandSender) -> { return iCommandSender.permissions().hasPermission(Permissions.COMMANDS_ADMIN) && iCommandSender.isPlayer(); })
